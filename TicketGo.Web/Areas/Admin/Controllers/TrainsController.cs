        ...
        public async Task<IActionResult> Index(string? searchTerm)
        {
            ...
            if (!string.IsNullOrWhiteSpace(searchTerm))
            {
                trains = trains.Where(t => 
                    (t.NameTrain != null && t.NameTrain.Contains(searchTerm, StringComparison.OrdinalIgnoreCase)) ||
                    (t.TrainRouteName != null && t.TrainRouteName.Contains(searchTerm, StringComparison.OrdinalIgnoreCase))
                ).ToList();
